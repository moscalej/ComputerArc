...
public:
	core();
	~core();
	void CoreClock(bool split_regfile, bool forwd);
	void Reset();
...
private:
	...
	int forwarding_unit(bool forwward);
...
void core::CoreClock(bool split_regfile,bool forwd)
{
	...
	*/
	...
	int core::forwarding_unit(bool forwward) {
		if (forwward == true)
		{
